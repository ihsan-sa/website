...
export const aboutContent = {
  title: "About Me",
  greeting: "",
  description: "My background is in high-speed hardware design, datacenter optical interconnects, and signal integrity. Every role I've held has been in a domain I was new to, and every time I was owning critical deliverables within weeks.\n\nAt Arista, I worked on next-gen optics for AI (12.8T XPO, CPO/NPO, and 1.6T modules) and ensured signal integrity on PCIe Gen 5 and 224G links.",
  interests: "This summer I'm joining Atomic Semi, focusing on RF amplifier and power systems for plasma generation. I hope to deepen my understanding of the chip fab process and move into chip design.\n\nI'm currently building ASIC experience through RISC-V based accelerator projects to develop experience in computer/DL architecture and RTL.",
  points: [],
  closing: "I see nuclear fusion as indispensable to a sustainable future and social impact and sustainability are core to my work.\n\nShoot me an email: <a href=\"mailto:hi@ihsan.cc\" class=\"about-link\">hi@ihsan.cc</a>",
